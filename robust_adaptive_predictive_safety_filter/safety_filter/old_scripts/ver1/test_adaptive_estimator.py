...
if __name__ == "__main__":
    ...
    AE = AdaptiveEstimator(theta_val=[model.c1, model.c2], f=model_adaptive, type='ConcurrentLearning', window=100, Theta=theta_bounds, nx=nx, nu=nu, integrator_type=policy_params['integrator_type'], dT=dt, cl_params=cl_params)
