...
if __name__ == "__main__":
    ...
    AE = AdaptiveEstimator(theta_val=[model.c1, model.c2], f=model_adaptive, window=100, Theta=theta_bounds, nx=nx, nu=nu, integrator_type=policy_params['integrator_type'], dT=dt, params=cl_params, sampling_time=Ta)
    ...
    CL_adapt = ClosedLoopSystemAdaptive(f=model, u=dummy_control, u_nom=u_ADPC, adaptive_estimator=AE, dt=dt,
