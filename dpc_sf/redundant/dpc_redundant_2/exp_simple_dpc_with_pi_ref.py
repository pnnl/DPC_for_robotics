...
state_ref_cat_node = Node(state_ref_cat, ['X_reduced', 'R_reduced'], ['XR_reduced'])
...
mlp_node = Node(mlp, ['XR_reduced'], ['xyz_thr'], name='mlp')
...
mlp_state_dict = torch.load("policy/DPC/policy_state_dict_ref.pth")
