...
class Trajectory:
    ...
    def __init__(self, quad, ctrlType, trajSelect, current_heading):
        ...
        self.t_wps = t_wps  # time allotted for each segment
        self.wps   = wps    # (xyz) of waypoints
        self.y_wps = y_wps  # yaw at each waypoint
        self.v_wp  = v_wp   # velocity desired at the waypoint?
    ...
    def desiredState(self, t, Ts, quad, pos):
        ...
        def pos_waypoint_arrived_wait(pos):
