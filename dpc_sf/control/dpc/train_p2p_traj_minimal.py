...
from dpc_sf.control.dpc.callback import LinTrajCallback
...
from dpc_sf.control.dpc.operations import Dynamics, processP2PTrajPolicyInput
...
def train_wp_traj(
        ...
        Q_terminal      = 10.0,                      # terminal penalty multiplier
    ...
    # --------------------
    callback = LinTrajCallback(save_dir=current_datetime, media_path=media_path, nstep=nstep, nx=nx, Ts=Ts)
