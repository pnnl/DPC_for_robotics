...
R = equation_reference('fig8', average_vel=0.5, include_actuators=include_actuators, set_vel_zero=set_vel_zero)
...
mlp_state_dict = torch.load("policy/DPC/wp_traj.pth")
