...
from dpc_sf.control.dpc.operations import processTrajPolicyInput

Ts = 0.001
include_actuators = True
set_vel_zero = False # dont set this true
save_path = "data/policy/DPC_traj/policy_experimental_tt_vel0.25.pth"
nstep = 20000
average_vel = 0.5
...
state_ref_cat = processTrajPolicyInput(use_error=True)
state_ref_cat_node = Node(state_ref_cat, ['X_reduced', 'R_reduced', 'P'], ['Obs'])

mlp = blocks.MLP(6 + 4, 3, bias=True,
